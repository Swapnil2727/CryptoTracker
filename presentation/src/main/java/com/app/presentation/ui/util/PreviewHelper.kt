...
internal val previewBitcoin = CryptoCurrency(
    ...
    marketCap = 1397360725394,
    marketCapRank = 1,
    totalVolume = 110266078010,
    high24h = 71604.0,
    low24h = 63924.0,
    priceChange24h = 6046.17,
    marketCapChange24h = 116636172054,
...
internal val previewEthereumNegative = CryptoCurrency(
    ...
    marketCap = 246284217655,
    marketCapRank = 2,
    totalVolume = 53838223165,
    high24h = 2184.66,
    low24h = 2020.4,
    priceChange24h = -113.42,
    marketCapChange24h = -13671289432,
...
internal val previewLowPriceCoin = CryptoCurrency(
    ...
    marketCap = 3678369193,
    marketCapRank = 30,
    totalVolume = 229042275,
    high24h = 0.0000064,
    low24h = 0.0000057,
    priceChange24h = 0.00000053,
    marketCapChange24h = 305385841,
...
internal val previewCryptoList = listOf(
    ...
    CryptoCurrency(
        ...
        marketCap = 185638317770,
        marketCapRank = 3,
        totalVolume = 183527367665,
        high24h = 0.999871,
        low24h = 0.998617,
        priceChange24h = 0.00095184,
        marketCapChange24h = 172454149,
    ...
    CryptoCurrency(
        ...
        marketCap = 88796043494,
        marketCapRank = 4,
        totalVolume = 2557758593,
        high24h = 667.0,
        low24h = 613.32,
        priceChange24h = 30.7,
        marketCapChange24h = 4086803163,
